...
class DatabaseTask(models.Model):
    ...
    task_path = models.CharField(max_length=512, help_text="Module path of the task function")
    queue_name = models.CharField(max_length=255, default="default", help_text="Queue name")
    ...
    kwargs_json = models.JSONField(default=dict, help_text="Keyword arguments (JSON format)")
    ...
    errors_json = models.JSONField(default=list, help_text="Error information (JSON format)")
